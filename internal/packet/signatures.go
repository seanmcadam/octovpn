...
const (
	...
	FIELD_COUNT PacketSigType = 0x00000400 // Requires WIDTH_32/64
	FIELD_ACK     PacketSigType = 0x00000800 // Requires WIDTH_32/64
	FIELD_NAK     PacketSigType = 0x00001000 // Requires WIDTH_32/64
	MASK_CAN      PacketSigType = FIELD_COUNT | FIELD_ACK | FIELD_NAK
	...
	DATA_START  PacketSigType = 0x000000FD
	DATA_CLOSE  PacketSigType = 0x000000FE
	DATA_ERROR  PacketSigType = 0x000000FF

	SIG_ERROR PacketSigType = 0xFFFFFFFF

	SIG_CONN_START  = VERSION_1 | LAYER_CONN | FIELD_SIG | FIELD_DATA | DATA_START
	SIG_CHAN_START  = VERSION_1 | LAYER_CHAN | FIELD_SIG | FIELD_DATA | DATA_START
	SIG_SITE_START  = VERSION_1 | LAYER_SITE | FIELD_SIG | FIELD_DATA | DATA_START
	SIG_ROUTE_START = VERSION_1 | LAYER_ROUTER | FIELD_SIG | FIELD_DATA | DATA_START

	SIG_CONN_CLOSE  = VERSION_1 | LAYER_CONN | FIELD_SIG | FIELD_DATA | DATA_CLOSE
	SIG_CHAN_CLOSE  = VERSION_1 | LAYER_CHAN | FIELD_SIG | FIELD_DATA | DATA_CLOSE
	SIG_SITE_CLOSE  = VERSION_1 | LAYER_SITE | FIELD_SIG | FIELD_DATA | DATA_CLOSE
	SIG_ROUTE_CLOSE = VERSION_1 | LAYER_ROUTER | FIELD_SIG | FIELD_DATA | DATA_CLOSE
	...
	// SITE
	//
	SIG_SITE_32_RAW    = SIG_SITE | FIELD_DATA | FIELD_COUNT | DATA_RAW | WIDTH_32 | SIZE_16
	SIG_SITE_32_PACKET = SIG_SITE | FIELD_DATA | FIELD_COUNT | DATA_PACKET | WIDTH_32 | SIZE_16
	SIG_SITE_32_AUTH   = SIG_SITE | FIELD_DATA | FIELD_COUNT | DATA_AUTH | WIDTH_32 | SIZE_16
	SIG_SITE_32_ID     = SIG_SITE | FIELD_DATA | FIELD_COUNT | DATA_ID | WIDTH_32 | SIZE_16
	SIG_SITE_32_ACK    = SIG_SITE | FIELD_ACK | WIDTH_32 | SIZE_8
	SIG_SITE_32_NAK    = SIG_SITE | FIELD_NAK | WIDTH_32 | SIZE_8
	SIG_SITE_64_RAW    = SIG_SITE | FIELD_DATA | FIELD_COUNT | DATA_RAW | WIDTH_64 | SIZE_16
	SIG_SITE_64_PACKET = SIG_SITE | FIELD_DATA | FIELD_COUNT | DATA_PACKET | WIDTH_64 | SIZE_16
	SIG_SITE_64_AUTH   = SIG_SITE | FIELD_DATA | FIELD_COUNT | DATA_AUTH | WIDTH_64 | SIZE_16
	SIG_SITE_64_ID     = SIG_SITE | FIELD_DATA | FIELD_COUNT | DATA_ID | WIDTH_64 | SIZE_16
	SIG_SITE_64_ACK    = SIG_SITE | FIELD_ACK | WIDTH_64 | SIZE_8
	SIG_SITE_64_NAK    = SIG_SITE | FIELD_NAK | WIDTH_64 | SIZE_8
	//
	// CHAN
	//
	SIG_CHAN_32_RAW    = SIG_CHAN | FIELD_DATA | FIELD_COUNT | DATA_RAW | WIDTH_32 | SIZE_16
	SIG_CHAN_32_PACKET = SIG_CHAN | FIELD_DATA | FIELD_COUNT | DATA_PACKET | WIDTH_32 | SIZE_16
	SIG_CHAN_32_PING   = SIG_CHAN | FIELD_PING | FIELD_COUNT | WIDTH_32 | SIZE_8
	SIG_CHAN_32_PONG   = SIG_CHAN | FIELD_PONG | FIELD_COUNT | WIDTH_32 | SIZE_8
	SIG_CHAN_32_ACK    = SIG_CHAN | FIELD_ACK | WIDTH_32 | SIZE_8
	SIG_CHAN_32_NAK    = SIG_CHAN | FIELD_NAK | WIDTH_32 | SIZE_8
	SIG_CHAN_64_RAW    = SIG_CHAN | FIELD_DATA | FIELD_COUNT | DATA_RAW | WIDTH_64 | SIZE_16
	SIG_CHAN_64_PACKET = SIG_CHAN | FIELD_DATA | FIELD_COUNT | DATA_PACKET | WIDTH_64 | SIZE_16
	SIG_CHAN_64_PING   = SIG_CHAN | FIELD_PING | FIELD_COUNT | WIDTH_64 | SIZE_8
	SIG_CHAN_64_PONG   = SIG_CHAN | FIELD_PONG | FIELD_COUNT | WIDTH_64 | SIZE_8
	SIG_CHAN_64_ACK    = SIG_CHAN | FIELD_ACK | WIDTH_64 | SIZE_8
	SIG_CHAN_64_NAK    = SIG_CHAN | FIELD_NAK | WIDTH_64 | SIZE_8
	//
	// CHAN
	//
	SIG_CONN_32_RAW    = SIG_CONN | FIELD_DATA | FIELD_COUNT | DATA_RAW | WIDTH_32 | SIZE_16
	SIG_CONN_32_PACKET = SIG_CONN | FIELD_DATA | FIELD_COUNT | DATA_PACKET | WIDTH_32 | SIZE_16
	SIG_CONN_32_PING   = SIG_CONN | FIELD_PING | FIELD_COUNT | WIDTH_32 | SIZE_8
	SIG_CONN_32_PONG   = SIG_CONN | FIELD_PONG | FIELD_COUNT | WIDTH_32 | SIZE_8
	SIG_CONN_32_AUTH   = SIG_CONN | FIELD_DATA | FIELD_COUNT | DATA_AUTH | WIDTH_32 | SIZE_16
	SIG_CONN_32_ID     = SIG_CONN | FIELD_DATA | FIELD_COUNT | DATA_ID | WIDTH_32 | SIZE_16
	SIG_CONN_64_RAW    = SIG_CONN | FIELD_DATA | FIELD_COUNT | DATA_RAW | WIDTH_64 | SIZE_16
	SIG_CONN_64_PACKET = SIG_CONN | FIELD_DATA | FIELD_COUNT | DATA_PACKET | WIDTH_64 | SIZE_16
	SIG_CONN_64_PING   = SIG_CONN | FIELD_PING | FIELD_COUNT | WIDTH_64 | SIZE_8
	SIG_CONN_64_PONG   = SIG_CONN | FIELD_PONG | FIELD_COUNT | WIDTH_64 | SIZE_8
	SIG_CONN_64_AUTH   = SIG_CONN | FIELD_DATA | FIELD_COUNT | DATA_AUTH | WIDTH_64 | SIZE_16
	SIG_CONN_64_ID     = SIG_CONN | FIELD_DATA | FIELD_COUNT | DATA_ID | WIDTH_64 | SIZE_16
)
...
func (p PacketSigType) Count() bool {
	return (p & FIELD_COUNT) != 0
}
...
func (p PacketSigType) Start() bool {
	switch p {
	case SIG_CONN_START:
		fallthrough
	case SIG_CHAN_START:
